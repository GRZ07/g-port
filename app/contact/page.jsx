...
const page = () => {
  return (
    <div className="sm:mx-auto sm:w-full sm:max-w-[1200px] py-10">
      <div className="wrapper bg-gray-50 dark:bg-slate-700 px-4 py-8 shadow-lg rounded-md sm:px-10">
        <div className="mb-10 text-gray-900 w-full">
          <h1 className="text-3xl font-bold uppercase dark:text-white">
            Get in touch!
          </h1>
          <span className="dark:text-white">Please allow 24 Hours for a response</span>
